          ...
          <div className="fade-in">
            ...
            {showCTA && (
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button 
                  className="bg-white text-blue-600 px-8 py-4 text-lg font-semibold hover:bg-blue-50 transition-colors h-auto"
                ...
                <Button 
                  variant="outline"
                  className="bg-transparent text-white border-2 border-white/50 px-8 py-4 text-lg font-semibold hover:bg-white/10 h-auto transition-colors"

...
import heroBackground from "@assets/generated_images/Realistic_night_dashboard_with_DPF_warning_b45cd1e7.png";
...
export default function Hero({ title, subtitle, showCTA = true, showStats = true }: HeroProps) {
  ...
  return (
    <section className="py-20 md:py-32 text-white relative overflow-hidden min-h-[600px]">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600/70 via-blue-700/60 to-blue-800/70"></div>
